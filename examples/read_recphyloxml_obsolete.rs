...
fn main() {
    ...
    read_recphyloxml_multi(
        "recphylo_examples/gene_1tree_obsolete_format.recphylo".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_obsolete_1.svg".to_string(),
    );
    ...
    let mut global_roots: std::vec::Vec<usize> = Vec::new();
    read_recphyloxml_multi(
        "recphylo_examples/gene_2tree_obsolete_format.recphylo".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_obsolete_2.svg".to_string(),
    );

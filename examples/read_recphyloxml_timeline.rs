...
fn main() {
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_timeline.svg".to_string(),
    );
    ...
    pictures.insert(
        "PNOVA".to_string(),
        "Mus_musculus_George_Shuklin.png:100:-60:10".to_string(),
    );
    pictures.insert(
        "PQUAD".to_string(),
        "Mus_musculus_George_Shuklin.png:100:-60:10".to_string(),
    ...
    pictures.insert(
        "species_17".to_string(),
        "Extant_tetrapoda.jpg:300:120:-20".to_string(),
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_timeline_pict.svg".to_string(),
    );

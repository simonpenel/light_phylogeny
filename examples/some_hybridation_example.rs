...
fn main() {
    ...
    read_recphyloxml_multi(
        "examples/reti2.recphylo".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "example_1_original.svg".to_string(),
    );
    ...
    options
        .hybrid
        .push(("RETI TEST".to_string(), "RETI TEST 2".to_string()));
    read_recphyloxml_multi(
        "examples/reti2.recphylo".to_string(),
        &mut sp_tree,
        &mut gene_trees,
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "example_1_hybridation_RETI.svg".to_string(),
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "example_2_original.svg".to_string(),
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "example_2_hybridation_PJENN_PMUL.svg".to_string(),
    );
    ...
    options
        .hybrid
        .push(("PPENT".to_string(), "PTRED".to_string()));
    read_recphyloxml_multi(
        "recphylo_examples/FAM000297_reconciliated.recphylo".to_string(),
        &mut sp_tree,
        &mut gene_trees,
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "example_2_hybridation_PPENT_PTRED.svg".to_string(),
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "example_2_hybridation_PPENT_PPRIMIR4.svg".to_string(),
    );
    println!(
        "Please open output file 'example_2_hybridation_PPENT_PPRIMIR4.svg' with your browser"
    );
    ...
    options
        .hybrid
        .push(("species_5".to_string(), "species_6".to_string()));
    read_recphyloxml_multi(
        "recphylo_examples/FAM000297_reconciliated.recphylo".to_string(),
        &mut sp_tree,
        &mut gene_trees,
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "example_2_hybridation_species_5_species_6.svg".to_string(),
    );
    println!(
        "Please open output file 'example_2_hybridation_species_5_species_6.svg' with your browser"
    );
    ...
    options
        .hybrid
        .push(("species_12".to_string(), "species_14".to_string()));
    read_recphyloxml_multi(
        "recphylo_examples/FAM000297_reconciliated.recphylo".to_string(),
        &mut sp_tree,
        &mut gene_trees,
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "example_2_hybridation_species_12_species_14.svg".to_string(),
    );

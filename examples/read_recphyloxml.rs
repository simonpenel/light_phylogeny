...
fn main() {
    ...
    phyloxml_processing(
        ...
        &mut options,
        &config,
        "read_recphyloxml_1gene.svg".to_string(),
    );
    ...
    let mut global_roots: std::vec::Vec<usize> = Vec::new();
    read_recphyloxml_multi(
        "examples/gene_parasite.recphylo".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    ...
    phyloxml_processing(
        ...
        &mut options,
        &config,
        "read_recphyloxml_1gene_bis.svg".to_string(),
    );
    ...
    let mut global_roots: std::vec::Vec<usize> = Vec::new();
    read_recphyloxml_multi(
        "examples/test_5genes.recphylo".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_mult.svg".to_string(),
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_mult_uni.svg".to_string(),
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_FAM000297_reconciliated.svg".to_string(),
    );
    println!(
        "Please open output file 'read_recphyloxml_FAM000297_reconciliated.svg' with your browser"
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_FAM000297_reconciliated_uni.svg".to_string(),
    );
    ...
    let mut global_roots: std::vec::Vec<usize> = Vec::new();
    read_recphyloxml_multi(
        "examples/hote_parasite_page4_BL.recphylo".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "hote_parasite_page4_BL.svg".to_string(),
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "hote_parasite_page4_BL_uni.svg".to_string(),
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "hote_parasite_page4_BL_real.svg".to_string(),
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "hote_parasite_page4_BL_real_landscape.svg".to_string(),
    );
    println!(
        "Please open output file 'hote_parasite_page4_BL_real_landscape.svg' with your browser"
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "hote_parasite_page4_BL_real_5.svg".to_string(),
    );
    ...
    let mut global_roots: std::vec::Vec<usize> = Vec::new();
    read_recphyloxml_multi(
        "examples/hote_parasite_page4_BL_2.recphylo".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "hote_parasite_page4_BL_uni_2.svg".to_string(),
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "hote_parasite_page4_BL_real_2.svg".to_string(),
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "hote_parasite_page4_BL_real_fonts.svg".to_string(),
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "hote_parasite_page4_BL_real_fonts_landcsape.svg".to_string(),
    );
    ...
    let mut global_roots: std::vec::Vec<usize> = Vec::new();
    read_recphyloxml_multi(
        "examples/hote_parasite_page4_BL_3.recphylo".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "hote_parasite_page4_BL_3_real_fonts_landcsape_tidy.svg".to_string(),
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "hote_parasite_page4_BL_3_real_fonts_landcsape.svg".to_string(),
    );

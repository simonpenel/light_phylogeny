...
fn main() {
    ...
    options.hybrid.push(("PBIAU".to_string(),"PTETRD4".to_string()));
    options.hybrid.push(("PQUAD".to_string(),"PNOVA".to_string()));
    ...
    read_recphyloxml_multi("recphylo_examples/FAM000600_reconciliated_big.recphylo".to_string(),

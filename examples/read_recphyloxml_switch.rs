...
fn main() {
    ...
    // read_recphyloxml("examples/gene_parasite_page2.recphylo".to_string(),
    //     &mut sp_tree, &mut gene_trees);

    // Conflit:
    // read_recphyloxml("examples/FAM000667_reconciliated.recphylo".to_string(),
    //     &mut sp_tree, &mut gene_trees);
    read_recphyloxml("examples/FAM000108_reconciliated.xml".to_string(),
        &mut sp_tree, &mut gene_trees);

    // read_recphyloxml("examples/FAM000696_reconciliated.recphylo".to_string(),
    //     &mut sp_tree, &mut gene_trees);

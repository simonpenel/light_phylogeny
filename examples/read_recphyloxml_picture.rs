...
fn main() {
    ...
    pictures.insert(
        "Homo".to_string(),
        "Zinaida-Serebryakova-Self-Portrait.jpg:100:50:90".to_string(),
    );
    pictures.insert("outgroup".to_string(), "Cisco.png:130:0:-400".to_string());
    pictures.insert(
        "Mus".to_string(),
        "Mus_musculus_George_Shuklin.png:130:60:-150".to_string(),
    );
    ...
    read_recphyloxml_multi(
        "examples/simple.recphyloxml".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_pictures.svg".to_string(),
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_pictures_2.svg".to_string(),
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_pictures_3.svg".to_string(),
    );

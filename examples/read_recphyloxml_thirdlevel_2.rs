...
fn main() {
    ...
    let transfers = vec![];
    let infile_gs = "examples/test1_mult_parasite/recgs_mult_host_dtl.recphyloxml".to_string();
    let infile_sh = "examples/test1_mult_parasite/rechp_dtl.recphyloxml".to_string();

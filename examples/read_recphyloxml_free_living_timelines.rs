...
fn main() {
    ...
    read_recphyloxml_multi(
        "examples/free_living_reconciliated.recphylo".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_free_living_reconciliated.svg".to_string(),
    );
    ...
    let mut global_roots: std::vec::Vec<usize> = Vec::new();
    read_recphyloxml_multi(
        "examples/free_living_reconciliated_2.recphylo".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_free_living_reconciliated_2.svg".to_string(),
    );

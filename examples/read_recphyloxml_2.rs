...
use light_phylogeny::{
    get_gtransfer, map_parasite_g2s, map_parasite_s2g, map_transfer, phyloxml_processing,
    read_recphyloxml_multi, recphyloxml_processing, reset_pos, summary, ArenaTree, Config, Options,
};
use log::info;
...
fn main() {
    ...
    recphyloxml_processing(
        ...
        "test_mapped_2levels.svg".to_string(),
    );
}

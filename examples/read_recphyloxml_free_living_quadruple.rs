...
fn main() {
    ...
    read_recphyloxml_multi(
        "examples/free_living_reconciliated_quadruple.recphylo".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_free_living_reconciliated_quadruple.svg".to_string(),
    );
    println!("Please open output file 'read_recphyloxml_free_living_reconciliated_quadruple.svg' with your browser");
}

...
use light_phylogeny::{
    phyloxml_processing, read_recphyloxml_multi, recphyloxml_processing, reset_pos, ArenaTree,
    Config, Options,
};
...
fn main() {
    ...
    read_recphyloxml_multi(
        "examples/recgs_mult_host_dtl.recphyloxml".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_multi.svg".to_string(),
    );
    // Version phylo
    ...
    let mut global_roots: std::vec::Vec<usize> = Vec::new();
    read_recphyloxml_multi(
        "examples/ex2comp.recphyloxml".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_multi_2.svg".to_string(),
    );
    // Version phylo
    reset_pos(&mut sp_tree);
    phyloxml_processing(
    ...
    let mut global_roots: std::vec::Vec<usize> = Vec::new();
    read_recphyloxml_multi(
        "examples/ex3comp.recphyloxml".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_multi_3.svg".to_string(),
    );
    // Version phylo
    reset_pos(&mut sp_tree);
    phyloxml_processing(
    ...
    let mut global_roots: std::vec::Vec<usize> = Vec::new();
    read_recphyloxml_multi(
        "examples/ex4comp.recphyloxml".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_multi_4.svg".to_string(),
    );
    // Version phylo
    reset_pos(&mut sp_tree);
    phyloxml_processing(
    ...
    let mut global_roots: std::vec::Vec<usize> = Vec::new();
    read_recphyloxml_multi(
        "examples/ex5comp.recphyloxml".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_multi_5.svg".to_string(),
    );
    // Version phylo
    reset_pos(&mut sp_tree);
    phyloxml_processing(
    ...
    let mut global_roots: std::vec::Vec<usize> = Vec::new();
    read_recphyloxml_multi(
        "examples/ex6comp.recphyloxml".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_multi_6.svg".to_string(),
    );
    // Version phylo
    reset_pos(&mut sp_tree);
    phyloxml_processing(
    ...
    let mut global_roots: std::vec::Vec<usize> = Vec::new();
    read_recphyloxml_multi(
        "examples/ex7comp.recphyloxml".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_multi_7.svg".to_string(),
    );
    // Version phylo
    reset_pos(&mut sp_tree);
    phyloxml_processing(
    ...
    let mut global_roots: std::vec::Vec<usize> = Vec::new();
    read_recphyloxml_multi(
        "examples/ex8comp.recphyloxml".to_string(),
        &mut sp_tree,
        &mut gene_trees,
        &mut global_roots,
    );
    ...
    recphyloxml_processing(
        ...
        true,
        &transfers,
        "read_recphyloxml_multi_8.svg".to_string(),
    );
    // Version phylo
    reset_pos(&mut sp_tree);
    phyloxml_processing(
